...
@Component({
  ...
  template: `
  <header class="relative bg-black flex items-center justify-center text-center px-4 sm:px-8 h-[70vh] sm:h-screen">
  ...
  <div class="relative z-20 container mx-auto max-w-3xl">
